...
class WaitingDreamScreen extends StatelessWidget {
  const WaitingDreamScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: StreamBuilder<QuerySnapshot<Dream>>(
          stream: FbFireStoreController().readWaitingDream(),
  ...
  Dream getDream(QueryDocumentSnapshot<Dream> queryDocumentSnapshot) {
    queryDocumentSnapshot.data().createdUid = queryDocumentSnapshot.id;
